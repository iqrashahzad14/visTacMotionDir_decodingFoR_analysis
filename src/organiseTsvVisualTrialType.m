...
tsvFileName = 'sub-005_ses-001_task-visual_run-009_events.tsv';
...
%     end
    if strcmp(output.trial_type(i),'visual_n/a')== 1
        output.trial_type(i)= strcat(output.modality_type(i),'_',output.ext_dir(i));
    elseif strcmp(output.trial_type(i),'visual_n/a')== 1
        output.trial_type(i)= strcat(output.modality_type(i),'_',output.ext_dir(i));
    end
