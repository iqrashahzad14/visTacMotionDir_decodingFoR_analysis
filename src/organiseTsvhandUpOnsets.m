...
tsvFileName = 'sub-005_ses-001_task-handUp_run-009_events.tsv';
...
%     if strcmp(output.trial_type(i),'handUp_vertical')== 1
%         output.trial_type(i)= strcat(output.modality_type(i),'_',output.anat_dir(i));
%     elseif strcmp(output.trial_type(i),'handUp_horizontal')== 1
%         output.trial_type(i)= strcat(output.modality_type(i),'_',output.anat_dir(i));
%     end
