...
function opt = getOptionVisualDecoding()
    %
 ...
 if nargin < 1
  ...
  % task to analyze
  opt.taskName = 'visual'; %'handDown' , 'handUp'
  ...
  % specify the model file that contains the contrasts to compute
    ...
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'model-visualDecoding_smdl.json'); %'model-FoR1Decoding_smdl.json'
