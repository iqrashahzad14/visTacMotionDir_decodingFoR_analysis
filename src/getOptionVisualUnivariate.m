...
function opt = getOptionVisualUnivariate()
    %
  ...
  % specify the model file that contains the contrasts to compute
    ...
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'model-visualUnivariate_smdl.json');
