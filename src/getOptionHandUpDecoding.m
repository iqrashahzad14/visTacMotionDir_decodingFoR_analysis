...
function opt = getOptionHandUpDecoding()
    %
 ...
 if nargin < 1
  ...
  % task to analyze
  opt.taskName = 'handUp'; %'handDown' , 'handUp'
  ...
  % specify the model file that contains the contrasts to compute
    ...
    opt.model.file =  ...
        fullfile(fileparts(mfilename('fullpath')), '..', ...
                 'model', 'model-handUpDecoding_smdl.json'); %'model-FoR1Decoding_smdl.json'
  ...
  opt.result.Steps(1).Contrasts(1).Name = 'handUp_vertical_1';
